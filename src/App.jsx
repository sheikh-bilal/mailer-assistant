      ...
      <main>
        ...
        <div className="features">
          ...
          <div className="feature">
            ...
            <p>
              Quickly generate context-aware email responses that match your
              tone and style for professional communication.
            </p>
          </div>
          ...
          <div className="feature">
            ...
            <p>
              Review and send the generated replies instantly with a single
              click, streamlining your email workflow.
            </p>
          </div>
        </div>
      </main>
      <footer>v1.0.0 • © Bilal-Ahmed</footer>
    </>
  );
}
